//Lexicon for assembly operations
...
{
    //ILE *fptr = fopen(argv[1], "rb"); //alternative way to input file if ran as argument
    FILE *fptr = fopen("G:\\Visual Studio\\Grug Cave\\Spring2025\\Systems Software\\input.txt", "rb");  
